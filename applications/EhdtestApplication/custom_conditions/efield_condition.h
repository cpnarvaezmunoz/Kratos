...
#if !defined(KRATOS_EFIELD_CONDITION_H_INCLUDED )
#define KRATOS_EFIELD_CONDITION_H_INCLUDED
...
class EfieldCondition : public Condition
{
public:
    ...
    /// Pointer definition of EfieldCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(EfieldCondition);
     ...
     * Constructor.
     */
    EfieldCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EfieldCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EfieldCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EfieldCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    EfieldCondition(EfieldCondition const& rOther);

    /**
     * Destructor
     */
    ~EfieldCondition() override;
    ...
    /// Assignment operator.
    EfieldCondition & operator=(EfieldCondition const& rOther);
...
#endif // KRATOS_EFIELD_CONDITION_H_INCLUDED  defined
