...
#if !defined(KRATOS_POINT_CHARGE_CONDITION_H_INCLUDED )
#define KRATOS_POINT_CHARGE_CONDITION_H_INCLUDED
...
class PointChargeCondition : public Condition
{
public:
    ...
    /// Pointer definition of PointChargeCondition
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(PointChargeCondition);
     ...
     * Constructor.
     */
    PointChargeCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    PointChargeCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    PointChargeCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    PointChargeCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    PointChargeCondition(PointChargeCondition const& rOther);

    /**
     * Destructor
     */
    ~PointChargeCondition() override;
    ...
    /// Assignment operator.
    PointChargeCondition & operator=(PointChargeCondition const& rOther);
...
#endif // KRATOS_POINT_CHARGE_CONDITION_H_INCLUDED  defined
