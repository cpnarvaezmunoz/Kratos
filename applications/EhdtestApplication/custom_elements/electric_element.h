...
#if !defined(KRATOS_ELECTRIC_ELEMENT_H_INCLUDED )
#define KRATOS_ELECTRIC_ELEMENT_H_INCLUDED
...
public:
    ...
    /// Pointer definition of ElectricElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ElectricElement);
     ...
     * Constructor.
     */
    ElectricElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    ElectricElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    ElectricElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    ElectricElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    ElectricElement(ElectricElement const& rOther);

    /**
     * Destructor
     */
    ~ElectricElement() override;
    ...
    /// Assignment operator.
    ElectricElement & operator=(ElectricElement const& rOther);
