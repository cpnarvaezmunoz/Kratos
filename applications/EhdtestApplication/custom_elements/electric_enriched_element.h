...
#if !defined(KRATOS_ELECTRIC_ENRICHED_ELEMENT_H_INCLUDED )
#define KRATOS_ELECTRIC_ENRICHED_ELEMENT_H_INCLUDED
...
class ElectricEnrichedElement : public Element
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ElectricEnrichedElement);
     ...
     * Constructor.
     */
    ElectricEnrichedElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    ElectricEnrichedElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    ElectricEnrichedElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    ElectricEnrichedElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    ElectricEnrichedElement(ElectricEnrichedElement const& rOther);

    /**
     * Destructor
     */
    ~ElectricEnrichedElement() override;
    ...
    /// Assignment operator.
    ElectricEnrichedElement & operator=(ElectricEnrichedElement const& rOther);
...
#endif // KRATOS_ENRICHED_ELEMENT_H_INCLUDED  defined
