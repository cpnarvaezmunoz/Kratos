...
#if !defined(KRATOS_ELECTRIC_DISTANCE_ELEMENT_H_INCLUDED )
#define KRATOS_ELECTRIC_DISTANCE_ELEMENT_H_INCLUDED
...
class ElectricDistanceElement : public Element
{
public:
    ...
    /// Pointer definition of ElectricDistanceElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ElectricDistanceElement);
     ...
     * Constructor.
     */
    ElectricDistanceElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    ElectricDistanceElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    ElectricDistanceElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    ElectricDistanceElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    ElectricDistanceElement(ElectricDistanceElement const& rOther);

    /**
     * Destructor
     */
    ~ElectricDistanceElement() override;
    ...
    /// Assignment operator.
    ElectricDistanceElement & operator=(ElectricDistanceElement const& rOther);
...
#endif // KRATOS_ELECTRIC_ELEMENT_H_INCLUDED  defined
