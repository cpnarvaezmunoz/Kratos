 ...
 * Constructor.
 */
ElectricEnrichedtElement::ElectricEnrichedtElement(IndexType NewId)
    : Element(NewId) 
{
}
 ...
 */
ElectricEnrichedtElement::ElectricEnrichedtElement(IndexType NewId, const NodesArrayType& ThisNodes)
 ...
 */
ElectricEnrichedtElement::ElectricEnrichedtElement(IndexType NewId, GeometryType::Pointer pGeometry)
 ...
 */
ElectricEnrichedtElement::ElectricEnrichedtElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
 ...
 * Copy Constructor
 */
ElectricEnrichedtElement::ElectricEnrichedtElement(ElectricEnrichedtElement const& rOther)
    : Element(rOther) 
{
}
 ...
 * Destructor
 */
ElectricEnrichedtElement::~ElectricEnrichedtElement()
{
}
...
/// Assignment operator.
ElectricEnrichedtElement & ElectricEnrichedtElement::operator=(ElectricEnrichedtElement const& rOther)
{
 ...
 */
Element::Pointer ElectricEnrichedtElement::Create(
    IndexType NewId,
    NodesArrayType const& ThisNodes,
    PropertiesType::Pointer pProperties) const
{
    KRATOS_TRY
    return Kratos::make_intrusive<ElectricEnrichedtElement>(NewId, GetGeometry().Create(ThisNodes), pProperties);
    KRATOS_CATCH("");
}
...
{
    KRATOS_TRY
    return Kratos::make_intrusive<ElectricEnrichedtElement>(NewId, pGeom, pProperties);
    KRATOS_CATCH("");
}
 ...
 * @return a Pointer to the new element
 */
Element::Pointer ElectricEnrichedtElement::Clone(IndexType NewId, NodesArrayType const& ThisNodes) const
{
    KRATOS_TRY
    return Kratos::make_intrusive<ElectricEnrichedtElement>(NewId, GetGeometry().Create(ThisNodes), pGetProperties());
    KRATOS_CATCH("");
}
 ...
 */
void ElectricEnrichedtElement::EquationIdVector(EquationIdVectorType& rResult, const ProcessInfo& CurrentProcessInfo) const
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::GetDofList(DofsVectorType& rElementalDofList, const ProcessInfo& CurrentProcessInfo) const
{
    unsigned int number_of_nodes = GetGeometry().PointsNumber();
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateLocalSystem(
    ...
    const ProcessInfo& rCurrentProcessInfo)
{
    ...
    //KRATOS_WATCH("FINISHED COMPUTING NON-CUT ELEMENTS...........")
            ...
            ////////////////////////////////////
            const double K1 = DN_DX[0](0,0)*fabs(distance[0]) + DN_DX[0](1,0)*fabs(distance[1]) + DN_DX[0](2,0)*fabs(distance[2])- DN_DX[0](0,0)*fabs(distance[0]) + DN_DX[0](1,0)*fabs(distance[1]) + DN_DX[0](2,0)*fabs(distance[2]);
            const double K2 = DN_DX[0](0,1)*fabs(distance[0]) + DN_DX[0](1,1)*fabs(distance[1]) + DN_DX[0](2,1)*fabs(distance[2])- DN_DX[0](0,1)*fabs(distance[0]) + DN_DX[0](1,1)*fabs(distance[1]) + DN_DX[0](2,1)*fabs(distance[2]);
            KRATOS_WATCH(DN_DX)
            ...
            enrich_gradient[0](0,0) = K1;
            enrich_gradient[0](0,1) = K2; 
               
            enrich_gradient[0](1,0) = - enrich_gradient[0](0,0);
            enrich_gradient[0](1,1) = - enrich_gradient[0](1,0);

            enrich_gradient[1](0,0) = K1;
            enrich_gradient[1](0,1) = K2;
               
            enrich_gradient[1](1,0) = - enrich_gradient[1](0,0);
            enrich_gradient[1](1,1) = - enrich_gradient[1](0,1);

            enrich_gradient[2](0,0) = K1;
            enrich_gradient[2](0,1) = K2;
            ...
            for (unsigned int i = 0; i < 3; i++){   
                    K_enrich(0,0) -= (pow(enrich_gradient[0](0,0),2)+pow(enrich_gradient[0](0,1),2))*permittivities(i)*areas(i);      
                    for (unsigned int j = 0; j < 3; j++){
                    B_node_enrich(0,j) -= DN_DX[0](j,0)*(enrich_gradient[0](0,0)*permittivities(i)*areas(i)) + DN_DX[0](j,1)*(enrich_gradient[0](0,1)*permittivities(i)*areas(i));
...
void ElectricEnrichedtElement::GetValueOnIntegrationPoints(const Variable<array_1d<double,3>>& rVariable, 
...
void ElectricEnrichedtElement::CalculateOnIntegrationPoints(const Variable<array_1d<double,3>>& rVariable, 
...
void ElectricEnrichedtElement::Calculate(const Variable<array_1d<double, 3 > >& rVariable,
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateLeftHandSide(MatrixType& rLeftHandSideMatrix, const ProcessInfo& rCurrentProcessInfo)
{
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateRightHandSide(VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo)
{
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateFirstDerivativesContributions(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateFirstDerivativesLHS(MatrixType& rLeftHandSideMatrix, const ProcessInfo& rCurrentProcessInfo)
{
    if (rLeftHandSideMatrix.size1() != 0)
        rLeftHandSideMatrix.resize(0, 0, false);
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateFirstDerivativesRHS(VectorType& rRightHandSideVector, const ProcessInfo& rCurrentProcessInfo)
{
    if (rRightHandSideVector.size() != 0)
        rRightHandSideVector.resize(0, false);
}
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateSecondDerivativesContributions(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateSecondDerivativesLHS(
    MatrixType& rLeftHandSideMatrix,
    const ProcessInfo& rCurrentProcessInfo)
{
    if (rLeftHandSideMatrix.size1() != 0)
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateSecondDerivativesRHS(
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo)
{
    if (rRightHandSideVector.size() != 0)
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateMassMatrix(MatrixType& rMassMatrix, const ProcessInfo& rCurrentProcessInfo)
{
 ...
 * @param rCurrentProcessInfo: the current process info instance
 */
void ElectricEnrichedtElement::CalculateDampingMatrix(MatrixType& rDampingMatrix, const ProcessInfo& rCurrentProcessInfo)
{
 ...
 */
int ElectricEnrichedtElement::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY
...
std::string ElectricEnrichedtElement::Info() const {
...
void ElectricEnrichedtElement::PrintInfo(std::ostream& rOStream) const {
    rOStream << "ElectricEnrichedElement #" << Id();
}

/// Print object's data.

void ElectricEnrichedtElement::PrintData(std::ostream& rOStream) const {
...
void ElectricEnrichedtElement::save(Serializer& rSerializer) const
{
...
void ElectricEnrichedtElement::load(Serializer& rSerializer)
{
...
inline std::istream & operator >> (std::istream& rIStream, ElectricEnrichedtElement& rThis);

/// output stream function
inline std::ostream & operator << (std::ostream& rOStream, const ElectricEnrichedtElement& rThis)
{
