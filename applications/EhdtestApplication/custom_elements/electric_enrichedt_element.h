...
#if !defined(KRATOS_ELECTRIC_ENRICHEDT_ELEMENT_H_INCLUDED )
#define KRATOS_ELECTRIC_ENRICHEDT_ELEMENT_H_INCLUDED
...
class ElectricEnrichedtElement : public Element
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ElectricEnrichedtElement);
     ...
     * Constructor.
     */
    ElectricEnrichedtElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    ElectricEnrichedtElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    ElectricEnrichedtElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    ElectricEnrichedtElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    ElectricEnrichedtElement(ElectricEnrichedtElement const& rOther);

    /**
     * Destructor
     */
    ~ElectricEnrichedtElement() override;
    ...
    /// Assignment operator.
    ElectricEnrichedtElement & operator=(ElectricEnrichedtElement const& rOther);
